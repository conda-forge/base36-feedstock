...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/base36-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13394&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/base36-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `base36` can be installed with:

```
conda install base36
```

It is possible to list all of the versions of `base36` available on your platform with:
